...
export const DashboardPage: React.FC = () => {
  ...
  const isLoading =
    loadingCustomers || loadingProperties || loadingApplications;
  ...
  const totalLoanValue = 0;
  const pendingReview = applications.filter((a) =>
    ["Submitted", "UnderReview"].includes(a.status),
  ).length;
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <p className="font-medium text-white">
                {pendingReview} application(s) pending review
              </p>
