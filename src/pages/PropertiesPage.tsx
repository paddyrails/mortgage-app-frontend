...
export const PropertiesPage: React.FC = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: string; data: CreatePropertyRequest }) =>
      propertyService.update(id, { id, ...data }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["properties"] });
  ...
  return (
    <div>
      ...
      <ConfirmDialog
        ...
        onConfirm={() =>
          deletingProperty && deleteMutation.mutate(deletingProperty.id)
        }
